...
echo "[$SYSTEM_PLATFORM] Project information: OpenSSL with deprecated ciphers: $PROJECT_OPENSSL_WITH_DEPRECATED_CIPHERS"
...
echo "[$SYSTEM_PLATFORM] Project information: OpenSSL with shared Zlib: $PROJECT_OPENSSL_WITH_SHARED_ZLIB"
echo "[$SYSTEM_PLATFORM] Project information: OpenSSL with Zlib: $PROJECT_OPENSSL_WITH_ZLIB"
